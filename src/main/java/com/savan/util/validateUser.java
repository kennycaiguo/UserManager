...
public class validateUser {
	...
	public String validateUserDetails(HttpServletRequest request, HttpServletResponse response) {
		...
		if (emailExist(request.getParameter("email"), request.getParameter("Register"))) {
			String error = "*Email Exists Please Try Another One..!!";
			return error;
		}
		if (isValidEmail(request.getParameter("email"))) {
			String error = "*Email should be in the 'xxx@xx.xx' Format..!!";
			return error;
		}
	...
	private boolean emailExist(String email,String operation) { 
