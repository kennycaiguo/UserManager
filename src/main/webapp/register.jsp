			...
			<div class="row">
				<div class="col-md-8 m-auto d-block">
					...
					<!-- manage address for existing user or new one -->
						...
						<span style="color:red" class="text-danger font-weight-bold">${sessionScope.errMassage}</span><br>
						<button type="submit" name="operation" value="<c:out value="${empty sessionScope.operation ? 'Register' : operation}" />" class="btn btn-success" form="Form" id="btn-submit" onclick="return validation(${count-1});">
