function validation(id) {
	...
	for (var count = 1; count <= id; count++) {
		...
		var house = document.getElementById('house'+count).value;
		var landmark = document.getElementById('landmark'+count).value;
		var City = document.getElementById('City'+count).value;
		var State = document.getElementById('State'+count).value;
		var Country = document.getElementById('Country'+count).value;
		var ZipCode = document.getElementById('ZipCode'+count).value;
